    ...
    for _ in range(3):  # Retry up to 3 times
        try:
            completion = client.chat.completions.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are a helpful assistant that extracts information from receipts. Please follow the rules and extract the requested information."},
...
def process_file(uploaded_file):
    ...
    if "picture" in df.columns:
        ...
        for index, row in df.iterrows():
            ...
            try:
                ...
                easyocr_text = extract_text_with_easyocr(preprocessed_img_path, reader)
    ...
    df = df[["image_index", "id", "date", "extracted_date", "customer", "user", "picture",
             "amount", "extracted_amount", "extracted_seller", "company_credit_card",
             "extracted_card_info", "extracted_text"]]
